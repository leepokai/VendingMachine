// paid_text_renderer.v
// Module: Paid Text Renderer
// Description: Renders text "PAID: $XXX" below the TOTAL line
// Character size: 8x16 pixels
// Display position: (8, 24) - one line below TOTAL

module paid_text_renderer (
    input wire clk,
    input wire reset,
    input wire [9:0] pixel_x,
    input wire [9:0] pixel_y,
    input wire [15:0] paid_amount,  // Value to display (0-9999)
...
localparam TEXT_Y_START = 24;  // Below TOTAL line (8 + 16 = 24)
localparam CHAR_WIDTH = 8;
localparam CHAR_HEIGHT = 16;
localparam NUM_CHARS = 9;  // "PAID: $XX"


// Calculate character position
wire [3:0] char_index;  // Which character (0-8)
...
// Convert paid_amount to BCD using Double Dabble algorithm
...
always @(*) begin
    case (char_index)
        4'd0: ascii_code = 7'h50;  // 'P'
        4'd1: ascii_code = 7'h41;  // 'A'
        4'd2: ascii_code = 7'h49;  // 'I'
        4'd3: ascii_code = 7'h44;  // 'D'
        4'd4: ascii_code = 7'h3A;  // ':'
        4'd5: ascii_code = 7'h24;  // '$'
        4'd6: ascii_code = 7'h30 + bcd_hundreds;   // Hundreds digit (BCD)
        4'd7: ascii_code = 7'h30 + bcd_tens;       // Tens digit (BCD)
        4'd8: ascii_code = 7'h30 + bcd_ones;       // Ones digit (BCD)
