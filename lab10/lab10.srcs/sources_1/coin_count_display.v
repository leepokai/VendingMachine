...
wire in_text0_line1 = (pixel_y_reg >= text0_line1_y) && (pixel_y_reg < text0_line1_y + CHAR_HEIGHT) &&
                      (pixel_x_reg >= TEXT_X_START) && (pixel_x_reg < TEXT_X_START + 4 * CHAR_WIDTH);
wire in_text1_line1 = (pixel_y_reg >= text1_line1_y) && (pixel_y_reg < text1_line1_y + CHAR_HEIGHT) &&
                      (pixel_x_reg >= TEXT_X_START) && (pixel_x_reg < TEXT_X_START + 4 * CHAR_WIDTH);
wire in_text2_line1 = (pixel_y_reg >= text2_line1_y) && (pixel_y_reg < text2_line1_y + CHAR_HEIGHT) &&
                      (pixel_x_reg >= TEXT_X_START) && (pixel_x_reg < TEXT_X_START + 5 * CHAR_WIDTH);
wire in_text3_line1 = (pixel_y_reg >= text3_line1_y) && (pixel_y_reg < text3_line1_y + CHAR_HEIGHT) &&
                      (pixel_x_reg >= TEXT_X_START) && (pixel_x_reg < TEXT_X_START + 6 * CHAR_WIDTH);
...
assign text_offset_y = in_text0_line1 ? (pixel_y_reg - text0_line1_y) :
                       in_text1_line1 ? (pixel_y_reg - text1_line1_y) :
                       in_text2_line1 ? (pixel_y_reg - text2_line1_y) :
                                        (pixel_y_reg - text3_line1_y);
