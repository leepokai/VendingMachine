...
// Algorithm: Iteratively dispense largest coins first ($100 -> $10 -> $5 -> $1)
...
module change_dispenser (
    ...
    input wire [7:0] avail_coin100,      // Available $100 coins
    ...
    output reg [7:0] dispense_coin100,   // $100 coins to dispense
...
localparam CALC_5   = 3'd3;
localparam CALC_1   = 3'd4;
localparam DONE     = 3'd5;

reg [2:0] state, next_state;
reg [15:0] remaining;           // Remaining amount to dispense
reg [7:0] count_100, count_10, count_5, count_1;  // Counters for each denomination
...
always @(*) begin
    case (state)
        ...
        CALC_100: begin
             // Check if we can dispense more $100 coins
            if (remaining >= 16'd100 && count_100 < avail_coin100)
                next_state = CALC_100; // Stay in this state
            else
                next_state = CALC_10;  // Move to $10
        end
...
always @(posedge clk or posedge reset) begin
    if (reset) begin
        ...
        case (state)
            ...
            CALC_100: begin
                // Dispense one $100 coin if possible
                if (remaining >= 16'd100 && count_100 < avail_coin100) begin
                    remaining <= remaining - 16'd100;
                    count_100 <= count_100 + 8'd1;
                end
            end
