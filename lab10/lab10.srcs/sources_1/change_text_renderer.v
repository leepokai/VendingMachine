// change_text_renderer.v
// Module: Change Text Renderer
// Description: Renders text "CHANGE: $XXX" below the PAID line
// Character size: 8x16 pixels
// Display position: (8, 40) - two lines below TOTAL

module change_text_renderer (
    input wire clk,
    input wire reset,
    input wire [9:0] pixel_x,
    input wire [9:0] pixel_y,
    input wire [15:0] change_amount,    // Change to display (0-9999)
...
localparam TEXT_Y_START = 40;  // Below PAID line (24 + 16 = 40)
localparam CHAR_WIDTH = 8;
localparam CHAR_HEIGHT = 16;
localparam NUM_CHARS = 11;  // "CHANGE: $XX"


// Calculate character position
wire [3:0] char_index;  // Which character (0-10)
...
// Convert change_amount to BCD using Double Dabble algorithm
...
always @(*) begin
    case (char_index)
        4'd0:  ascii_code = 7'h43;  // 'C'
        4'd1:  ascii_code = 7'h48;  // 'H'
        4'd2:  ascii_code = 7'h41;  // 'A'
        4'd3:  ascii_code = 7'h4E;  // 'N'
        4'd4:  ascii_code = 7'h47;  // 'G'
        4'd5:  ascii_code = 7'h45;  // 'E'
        4'd6:  ascii_code = 7'h3A;  // ':'
        4'd7:  ascii_code = 7'h24;  // '$'
        4'd8:  ascii_code = 7'h30 + bcd_hundreds;   // Hundreds digit (BCD)
        4'd9:  ascii_code = 7'h30 + bcd_tens;       // Tens digit (BCD)
        4'd10: ascii_code = 7'h30 + bcd_ones;       // Ones digit (BCD)
